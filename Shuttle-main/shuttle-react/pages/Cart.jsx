...
export default function Cart() {
	const [cartItems, setCartItems] = useState([<CartItem />, <CartItem />, <CartItem />]);
		...
		<>
			...
			<div id="cart--container">
				...
				<div id="cart--summary">
					...
					<button id="checkout--btn"><Link to="/Checkout">Proceed to checkout</Link></button>
				</div>
			</div>
			<Footer />
		</>
